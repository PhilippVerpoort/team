...
<p align="center">
  <img src="assets/logos/logo-light.svg" class="only-light" alt="TEAM Header Logo" style="max-width: 600px; width: 100%; margin-bottom: 20px;">
  <img src="assets/logos/logo-dark.svg" class="only-dark" alt="TEAM Header Logo" style="max-width: 600px; width: 100%; margin-bottom: 20px;">
</p>
