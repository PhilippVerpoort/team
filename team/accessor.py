        ...
        for pivot_group_cols, pivot_group_row in pivot_groups.items():
            ...
            for func_specs in funcs:
                ...
                df_pivot_group_mapped = (
                    df_pivot_group
                    .rename(columns=pre_mapper)
                ) if pre_mapper is not None else df_pivot_group

                # Call function.
                df_pivot_group_ret = func(df_pivot_group_mapped, *args, **kwargs)
                ...
                if (
                    df_pivot_group_ret.empty or
                    df_pivot_group_ret.isnull().all().all()
                ):
                    continue
